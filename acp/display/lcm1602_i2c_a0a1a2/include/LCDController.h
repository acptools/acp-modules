#ifndef MODULES_ACP_DISPLAY_LCM1602_I2C_A0A1A2_INCLUDE_LCDCONTROLLER_H_
#define MODULES_ACP_DISPLAY_LCM1602_I2C_A0A1A2_INCLUDE_LCDCONTROLLER_H_

#include <acp/core.h>
#include <acp/display/libs/base_api/BaseDisplay.h>
#include <acp/display/libs/basic_hw_types/LiquidCrystal_I2C.h>

namespace acp_display_lcm1602_i2c_a0a1a2 {
	...
	public:
		...
		LCDController():lcd(0x20, 2, 1, 0, 4, 5, 6, 7, 3, POSITIVE) {
			// nothing to do
		}
...
#endif /* MODULES_ACP_DISPLAY_LCM1602_I2C_A0A1A2_INCLUDE_LCDCONTROLLER_H_ */
