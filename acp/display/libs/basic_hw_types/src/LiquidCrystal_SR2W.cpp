...
LiquidCrystal_SR2W::LiquidCrystal_SR2W(uint8_t srdata, uint8_t srclock,
		t_backlighPol blpol) {
...
//
// init
void LiquidCrystal_SR2W::init(uint8_t srdata, uint8_t srclock,
		t_backlighPol blpol, uint8_t lines, uint8_t font) {
