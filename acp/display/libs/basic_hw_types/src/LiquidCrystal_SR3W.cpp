...
namespace acp_display_libs_basic_hw {

LiquidCrystal_SR3W::LiquidCrystal_SR3W(uint8_t data, uint8_t clk,
		uint8_t strobe) {
	init(data, clk, strobe, RS, RW, EN, D4, D5, D6, D7);
}

LiquidCrystal_SR3W::LiquidCrystal_SR3W(uint8_t data, uint8_t clk,
		uint8_t strobe, uint8_t backlighPin, t_backlighPol pol) {
	init(data, clk, strobe, RS, RW, EN, D4, D5, D6, D7);
	setBacklightPin(backlighPin, pol);
}

LiquidCrystal_SR3W::LiquidCrystal_SR3W(uint8_t data, uint8_t clk,
		uint8_t strobe, uint8_t En, uint8_t Rw, uint8_t Rs, uint8_t d4,
...
LiquidCrystal_SR3W::LiquidCrystal_SR3W(uint8_t data, uint8_t clk,
		uint8_t strobe, uint8_t En, uint8_t Rw, uint8_t Rs, uint8_t d4,
		uint8_t d5, uint8_t d6, uint8_t d7, uint8_t backlighPin,
		t_backlighPol pol) {
	init(data, clk, strobe, Rs, Rw, En, d4, d5, d6, d7);
	setBacklightPin(backlighPin, pol);
}
...
void LiquidCrystal_SR3W::setBacklightPin(uint8_t value, t_backlighPol pol =
		POSITIVE) {
...
int LiquidCrystal_SR3W::init(uint8_t data, uint8_t clk, uint8_t strobe,
		uint8_t Rs, uint8_t Rw, uint8_t En, uint8_t d4, uint8_t d5, uint8_t d6,
		uint8_t d7) {
